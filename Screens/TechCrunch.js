...
export default class TechCrunch extends React.Component{
    state={
        data:[],
        isLoading : true,
        refreshing:false
    ...
    loadnews = () => {
        Axios.get('https://newsapi.org/v2/top-headlines?sources=techcrunch&pageSize=100&apiKey=b2fe096b9727464c8d5f42f48c1614a6')
        .then((response)=>{
